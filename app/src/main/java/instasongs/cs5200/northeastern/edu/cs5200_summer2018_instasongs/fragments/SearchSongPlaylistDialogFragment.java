...
public class SearchSongPlaylistDialogFragment extends DialogFragment implements PlaylistItemClickListener{
    ...
    public SearchSongPlaylistDialogFragment(){
    }
    ...
    public void onItemClick(View v, int position) {
        ...
        song.setPlayCount(Long.parseLong(mTrack.getListeners()));
        song.setImageUrl(mTrack.getImage().get(3).getText());
        song.setStreamUrl(mTrack.getUrl());

        Artist artist = new Artist();
        artist.setName(mTrack.getArtist());
